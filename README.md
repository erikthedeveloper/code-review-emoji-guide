...
|  ⛏🐐  |   `:pick:` `:goat:`   | This is a nitpick, or, this gets my goat<sup>[*](https://www.dictionary.com/browse/get-someone-s-goat)</sup>. <br /><br /> This does not require any changes and is often better left unsaid. This may include stylistic, formatting, or organization suggestions and should likely be prevented/enforced by linting if they really matter |
